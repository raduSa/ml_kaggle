...
# model.save_weights('snd.weights.h5')
...
tuner = kt.RandomSearch(
    ...
    max_trials=200,  # Try 20 different combinations
    directory='tuning_dir',
    project_name='animal_classifier')

tuner.search(train_generator, validation_data=validation_generator, epochs=1, callbacks=[early_stopping])
